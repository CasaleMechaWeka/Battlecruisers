...
namespace BattleCruisers.AI.ThreatMonitors
{
    ...
    {
        private readonly BaseThreatMonitor _coreThreatMonitor;
        ...
        public DelayedThreatMonitor(BaseThreatMonitor coreThreatMonitor, ITime time, IDeferrer deferrer, float delayInS = DEFAULT_DELAY_IN_S)
        {
