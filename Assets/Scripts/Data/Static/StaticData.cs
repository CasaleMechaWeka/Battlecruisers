    ...
    public class StaticData : IStaticData
    {
        ...
        private IList<ILevel> CreateLevels()
        {
            return new List<ILevel>()
            {
                ...
                new Level(31, Hulls.HuntressBoss, BackgroundMusic.Fortress, SkyMaterials.Sunrise, Exos.GetCaptainExoKey(31)), //HUNTRESS PRIME
        ...
        private List<ISideQuestData> CreateSideQuests()
        {
            return new List<ISideQuestData>()
            {
                ...
                new SideQuestData(false, Exos.GetCaptainExoKey(29), 27, -1 , Hulls.Pistol, BackgroundMusic.Confusion, SkyMaterials.Purple, false, 17),
                ...
                new SideQuestData(false, Exos.GetCaptainExoKey(48), 32, 22 , Hulls.FortressPrime, BackgroundMusic.Fortress, SkyMaterials.Midnight, false, 23)
            };
        }
