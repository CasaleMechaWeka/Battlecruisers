...
{
    public class KamikazooController : AircraftController, ITargetConsumer
    {
        private FollowingXAxisMovementController _outsideRangeMovementController, _inRangeMovementController;
        private IBarrelWrapper _minigunBarrelWrapper;
        ...
        private void SetupTargetDetection()
        {
            ...
            ITargetFilter enemyDetectionFilter = TargetFilterFactory.CreateTargetFilter(EnemyCruiser.Faction, AttackCapabilities);
