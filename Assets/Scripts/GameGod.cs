...
public class GameGod : MonoBehaviour 
{
	...
	private void InitializeBuildMenuController()
	{
		Building[] factories = 
		{
			new Building("Naval Factory", "Makes ships", 2, TechLevel.T1, BuildingCategory.Factory),
			new Building("Aircraft Factory", "Makes aircraft", 2, TechLevel.T1, BuildingCategory.Factory)
		};
		...
		Building[] turrets = 
		{
			new Building("Solid Shooter", "Small turret good against weak ships", 2, TechLevel.T1, BuildingCategory.Turret),
			new Building("Big Bad Blaster", "Strong turret good against all ships", 6, TechLevel.T2, BuildingCategory.Turret)
		};
