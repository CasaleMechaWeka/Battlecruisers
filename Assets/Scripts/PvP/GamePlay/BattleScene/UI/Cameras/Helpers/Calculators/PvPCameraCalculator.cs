...
namespace BattleCruisers.Network.Multiplay.Matchplay.MultiplayBattleScene.UI.Cameras.Helpers.Calculators
{
    public class PvPCameraCalculator : IPvPCameraCalculator
    {
        ...
        public PvPCameraCalculator(IPvPCamera camera, IPvPCameraCalculatorSettings settings)
        {
        ...
        public float FindCameraOrthographicSize(IPvPCruiser cruiser)
        {

            float desiredWidth = cruiser.Size.x * _settings.CruiserWidthMultiplier;
            if (!cruiser.IsPvPCruiser())
            {
                desiredWidth = 30.0f;
            }
        ...
        public Vector3 FindCruiserCameraPosition(IPvPCruiser cruiser, float orthographicSize, float zValue)
        {
