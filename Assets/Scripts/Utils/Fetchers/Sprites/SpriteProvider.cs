...
namespace BattleCruisers.Utils.Fetchers.Sprites
{
    public class SpriteProvider : ISpriteProvider
    {
        ...
        public async Task<IList<ISpriteWrapper>> GetMissileFighterSpritesAsync()
        {
        ...
        public async Task<IList<ISpriteWrapper>> GetSteamCopterSpritesAsync()
        {
        ...
        public async Task<IList<ISpriteWrapper>> GetStratBomberSpritesAsync()
        {
