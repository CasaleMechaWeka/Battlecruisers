...
namespace BattleCruisers.UI.ScreensScene
{
    public class BodykitsContainer : MonoBehaviour
    {
        ...
        private async void Purchase()
        {
            ...
            {
                ScreensSceneGod.Instance.processingPanel.SetActive(false);
                //STEAMHOTFIX    ScreensSceneGod.Instance.messageBox.ShowMessage(screensSceneTable.GetString("InsufficientCoins"), GotoBlackMarket, screensSceneTable.GetString("GetCoins"));
