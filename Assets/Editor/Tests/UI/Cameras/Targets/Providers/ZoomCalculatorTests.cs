...
namespace BattleCruisers.Tests.UI.Cameras.Targets.Providers
{
    public class ZoomCalculatorTests
    {
        ...
        public void TestSetup()
        {
            ...
            _calculator = new ZoomCalculator(_camera, _deltaTimeProvider, _validOrthographicSizes);
        ...
        public void FindZoomDelta_NegativeMouseScrollDeltaY()
        {
            ...
            float expectedZoomDelta = Mathf.Abs(mouseScrollDeltaY) * orthographicProportion * ZoomCalculator.ZOOM_SCALE * _deltaTimeProvider.UnscaledDeltaTime;
