...
namespace BattleCruisers.Network.Multiplay.Matchplay.MultiplayBattleScene.DigitalRuby.LightningBolt
{
    /// <summary>
    /// Types of animations for lightning bolts
    /// </summary>
    public enum PvPLightningBoltAnimationMode
    {
        /// <summary>
        /// No animation
        /// </summary>
    ...
    public class PvPLightningBoltScript : MonoBehaviour
    {
        ...
        public PvPLightningBoltAnimationMode AnimationMode = PvPLightningBoltAnimationMode.PingPong;
        ...
        private void SelectOffsetFromAnimationMode()
        {
            ...
            if (AnimationMode == PvPLightningBoltAnimationMode.None)
            {
                lineRenderer.material.mainTextureOffset = offsets[0];
                return;
            }
            else if (AnimationMode == PvPLightningBoltAnimationMode.PingPong)
            {
            ...
            else if (AnimationMode == PvPLightningBoltAnimationMode.Loop)
            {
                index = animationOffsetIndex++;
                if (animationOffsetIndex >= offsets.Length)
                {
